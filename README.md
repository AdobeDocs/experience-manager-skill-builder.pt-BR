...
Os membros da comunidade do Adobe que desejam criar um novo artigo ou sugerir atualizações significativas devem iniciar o processo enviando um problema por meio da guia Problemas do repositório Git, abrindo a caixa de diálogo com a equipe de documentação. Depois de concordar com um plano, trabalhe com um funcionário para ajudá-lo a inserir o novo conteúdo por meio de uma combinação de trabalho nos repositórios públicos e privados.
...
Escritores técnicos, gerentes de programas e desenvolvedores responsáveis pela criação da documentação do Adobe Experience Cloud devem contribuir por meio do repositório privado em `https://git.corp.adobe.com/AdobeDocs`.
...
* [Noções básicas do Markdown](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github)
* [Cheatsheet de markdown para impressão](https://enterprise.github.com/downloads/en/markdown-cheatsheet.pdf)
