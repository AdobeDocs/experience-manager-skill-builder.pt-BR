...
# [!DNL Dynamic Media]- Adobe série [!DNL Experience Manager Assets]

Use esta série de webinários de cinco partes para criar sua base de conhecimento e maximizar seu investimento no Adobe [!DNL Experience Manager Assets]. Descubra ou aperfeiçoe sua experiência no Adobe [!DNL Experience Manager Assets] com um aprofundamento focado em seus cinco recursos essenciais — o rápido curso para a proficiência. Os especialistas da Adobe analisam os conceitos básicos e também fornecem insights avançados que permitem definir as próximas etapas acionáveis que você pode colocar em prática imediatamente.
